d3 = function() {
  ...
  var d3_format_decimalPoint = ",", d3_format_thousandsSeparator = " ", d3_format_grouping = [ 3, 3 ], d3_format_currencySymbol = "Eu";
  ...
  var d3_time_days = [ "Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi" ], d3_time_dayAbbreviations = [ "Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam" ], d3_time_months = [ "janvier", "février", "mars", "avril", "mai", "juin", "juillet", "août", "septembre", "octobre", "novembre", "décembre" ], d3_time_monthAbbreviations = [ "jan", "fév", "mar", "avr", "mai", "jui", "jul", "aoû", "sep", "oct", "nov", "déc" ];
